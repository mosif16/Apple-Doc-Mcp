...
async fn handle(context: Arc<AppContext>, args: Args) -> Result<ToolResponse> {
    ...
    match provider {
        ...
        | ProviderType::Metal | ProviderType::GameDev => {
            ...
            match provider {
                ...
                // Mlx, HuggingFace, QuickNode, ClaudeAgentSdk, Vertcoin, Cuda, Metal, and GameDev use the unified query tool
                ProviderType::Mlx | ProviderType::HuggingFace | ProviderType::QuickNode | ProviderType::ClaudeAgentSdk | ProviderType::Vertcoin | ProviderType::Cuda | ProviderType::Metal | ProviderType::GameDev => {
