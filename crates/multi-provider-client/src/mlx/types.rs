...
pub const MLX_PYTHON_TOPICS: &[(&str, &str, &str)] = &[
    // Core
    ("mlx.core.array", "python-api/mlx.core.array", "The core array class"),
    ("mlx.core.zeros", "python-api/mlx.core.zeros", "Create array of zeros"),
    ("mlx.core.ones", "python-api/mlx.core.ones", "Create array of ones"),
    ("mlx.core.reshape", "python-api/mlx.core.reshape", "Reshape an array"),
    ("mlx.core.matmul", "python-api/mlx.core.matmul", "Matrix multiplication"),
    ("mlx.core.compile", "python-api/mlx.core.compile", "JIT compile a function"),
    ("mlx.core.eval", "python-api/mlx.core.eval", "Evaluate arrays"),
    ("mlx.core.grad", "python-api/mlx.core.grad", "Gradient computation"),

    // Neural Networks
    ("mlx.nn.Module", "python-api/mlx.nn.Module", "Base neural network module"),
    ("mlx.nn.Linear", "python-api/mlx.nn.Linear", "Linear layer"),
    ("mlx.nn.Conv1d", "python-api/mlx.nn.Conv1d", "1D convolution layer"),
    ("mlx.nn.Conv2d", "python-api/mlx.nn.Conv2d", "2D convolution layer"),
    ("mlx.nn.Embedding", "python-api/mlx.nn.Embedding", "Embedding layer"),
    ("mlx.nn.LayerNorm", "python-api/mlx.nn.LayerNorm", "Layer normalization"),
    ("mlx.nn.RMSNorm", "python-api/mlx.nn.RMSNorm", "RMS normalization"),
    ("mlx.nn.MultiHeadAttention", "python-api/mlx.nn.MultiHeadAttention", "Multi-head attention"),
    ("mlx.nn.Transformer", "python-api/mlx.nn.Transformer", "Transformer components"),

    // Optimizers
    ("mlx.optimizers.SGD", "python-api/mlx.optimizers.SGD", "SGD optimizer"),
    ("mlx.optimizers.Adam", "python-api/mlx.optimizers.Adam", "Adam optimizer"),
    ("mlx.optimizers.AdamW", "python-api/mlx.optimizers.AdamW", "AdamW optimizer"),
